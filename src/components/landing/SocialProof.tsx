const logos = [
// Google
<svg key="google" className="h-8 w-auto text-gray-500 hover:text-gray-300 transition-colors flex-shrink-0" viewBox="0 0 272 92" fill="currentColor">
...
// Microsoft
<svg key="microsoft" className="h-7 w-auto text-gray-500 hover:text-gray-300 transition-colors flex-shrink-0" viewBox="0 0 318 69" fill="currentColor">
...
// GitHub
<svg key="github" className="h-8 w-auto text-gray-500 hover:text-gray-300 transition-colors flex-shrink-0" viewBox="0 0 98 96" fill="currentColor">
...
// AWS
<svg key="aws" className="h-6 w-auto text-gray-500 hover:text-gray-300 transition-colors flex-shrink-0" viewBox="0 0 304 182" fill="currentColor">
...
// Meta
<svg key="meta" className="h-7 w-auto text-gray-500 hover:text-gray-300 transition-colors flex-shrink-0" viewBox="0 0 512 512" fill="currentColor">
...
// Stripe
<svg key="stripe" className="h-8 w-auto text-gray-500 hover:text-gray-300 transition-colors flex-shrink-0" viewBox="0 0 468 222" fill="currentColor">
...
const SocialProof = () => {
  return <section className="py-20 border-y border-white/10 mx-0 px-0 my-[10px] overflow-hidden relative z-10">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          ...
          <div className="flex animate-scroll">
            ...
            <div className="flex items-center gap-16 md:gap-24 px-8">
              {logos.map((logo, i) => <span key={`dup-${i}`}>{logo}</span>)}
            </div>
          </div>
        </div>
      </div>
